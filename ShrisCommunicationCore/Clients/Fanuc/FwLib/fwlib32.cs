...
namespace ShrisCommunicationCore
{
    ...
    public class REALPRMS
    {
        ...
        public class IODBTR1
        {
            ...
            public IODBTR_data data6 = new IODBTR_data();
            public IODBTR_data data7 = new IODBTR_data();
            public IODBTR_data data8 = new IODBTR_data();
            public IODBTR_data data9 = new IODBTR_data();
            public IODBTR_data data10 = new IODBTR_data();
            public IODBTR_data data11 = new IODBTR_data();
            public IODBTR_data data12 = new IODBTR_data();
        } /* In case that the number of data is 5 */
        [StructLayout(LayoutKind.Sequential, Pack = 4)]
        public class IODBTR
        {
        ...
        public class ODBTG1
        {
            ...
            public ODBTG_data data6 = new ODBTG_data();
            public ODBTG_data data7 = new ODBTG_data();
            public ODBTG_data data8 = new ODBTG_data();
            public ODBTG_data data9 = new ODBTG_data();
            public ODBTG_data data10 = new ODBTG_data();
            public ODBTG_data data11 = new ODBTG_data();
            public ODBTG_data data12 = new ODBTG_data();
        } /* In case that the number of data is 5 */
        [StructLayout(LayoutKind.Sequential, Pack = 4)]
        public class ODBTG
        {
    ...
    public class ODBST
    {
        ...
        public class ODBST
        {
            ...
            public short aut;       /* selected automatic mode */
            public short manual;    /* selected automatic mode */
            public short run;       /* running status */
            public short motion;    /* axis, dwell status */
            public short mstb;      /* m, s, t, b status */
            public short emergency; /* emergency stop status */
    ...
    public static extern short cnc_rddynamic(ushort FlibHndl,
        ...
        /// ÷˜÷·ÀŸ∂»
        /// </summary>
        /// <param name="FlibHndl">æ‰±˙</param>
        /// <param name="a">÷˜÷·À≥–Ú∫≈ 1-n</param>
        /// <param name="b">∑µªÿ ˝æ›</param>
        /// <returns></returns>
