...
namespace iPlant.Data.EF.Repository
{
    ...
    public class Repository
    {
        ...
        {
            return await db.ExecuteBySql(strSql, wParams);
        }
        ...
        {
            return await db.ExecuteByProc(procName, wParams);
        }
        #endregion
        ...
        public async Task<int> Delete<T>(Int64 id) where T : class
        {
            return await db.Delete<T>(id);
        }
        public async Task<int> Delete<T>(Guid[] id) where T : class
        ...
        public async Task<int> Delete<T>(Int32[] id) where T : class
        {
            return await db.Delete<T>(id);
        }
        public async Task<int> Delete<T>(string propertyName, Guid propertyValue) where T : class
        {
        ...
        #region 对象实体 查询
        public async Task<T> FindEntity<T>(Guid id) where T : class
        {
        ...
        public async Task<IEnumerable<T>> FindList<T>(string strSql, Dictionary<String, Object> wParams) where T : class
        {
            ...
            return await db.FindList<T>(strSql, wParams);
        }
        ...
        //public async Task<IEnumerable<T>> FindList<T>(string strSql, Pagination pagination) where T : class
        //{
        //    int total = pagination.TotalCount;
        //    var data = await db.FindList<T>(strSql, pagination.Sort, pagination.SortType.ToLower() == "asc" ? true : false, pagination.PageSize, pagination.PageIndex);
        //    pagination.TotalCount = total;
        ...
        public async Task<IEnumerable<T>> FindList<T>(string strSql, Dictionary<String, Object> wParams, Pagination pagination) where T : class
        {
            var data = await db.FindList<T>(strSql, wParams, pagination.Sort, pagination.SortType.ToLower() == "asc" ? true : false, pagination.PageSize, pagination.PageIndex);
            pagination.TotalCount = data.total;
            return data.Item2;
        }
        ...
        {
            return await db.FindTable(strSql, wParams);
        }
        ...
        public async Task<DataTable> FindTable(string strSql, Dictionary<String, Object> wParams, Pagination pagination)
        {
            var data = await db.FindTable(strSql, wParams, pagination.Sort, pagination.SortType.ToLower() == "asc" ? true : false, pagination.PageSize, pagination.PageIndex);
            pagination.TotalCount = data.total;
            return data.Item2;
        }
        ...
        {
            return await db.FindObject(strSql, wParams);
        }
