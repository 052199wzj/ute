...
namespace iPlant.Data.EF
{
    public interface IDatabase
    {
        ...
        Task<int> ExecuteBySql(string strSql, Dictionary<String, Object> wParams);
        Task<int> ExecuteByProc(string procName);
        Task<int> ExecuteByProc(string procName, DbParameter[] dbParameter);
        Task<int> ExecuteByProc(string procName, Dictionary<String, Object> wParams);
        ...
        Task<int> Delete<T>(Int64 id) where T : class;

        Task<int> Delete<T>(Dictionary<String,Object> wParmas) where T : class;

        Task<int> Delete<T>(Guid[] id) where T : class;

        Task<int> Delete<T>(Int32[] id) where T : class;
        Task<int> Delete<T>(Int64[] id) where T : class;
        ...
        Task<IEnumerable<T>> FindList<T>(string strSql, Dictionary<String, Object> wParams) where T : class;
        ...
        //Task<IEnumerable<T>> FindList<T>(string strSql, string sort, bool isAsc, int pageSize, int pageIndex) where T : class;
        ...
        Task<(int total, IEnumerable<T>)> FindList<T>(string strSql, Dictionary<String, Object> wParams, string sort, bool isAsc, int pageSize, int pageIndex) where T : class;

        Task<DataTable> FindTable(string strSql);
        Task<DataTable> FindTable(string strSql, DbParameter[] dbParameter);
        Task<DataTable> FindTable(string strSql, Dictionary<String, Object> wParams);
        ...
        Task<(int total, DataTable)> FindTable(string strSql, Dictionary<String, Object> wParams, string sort, bool isAsc, int pageSize, int pageIndex);
        Task<object> FindObject(string strSql);
        Task<object> FindObject(string strSql, DbParameter[] dbParameter);
        Task<object> FindObject(string strSql, Dictionary<String, Object> wParams);
